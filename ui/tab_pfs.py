...
def build_pfs_tab(parent, app):
    ...
    tile_convert = _make_path_tile(sel_frame, 'convert',
        ...
        'Pack an .exfat/.ffpkg image into a mountable .ffpfsc (the stable route)')
    ...
    # ════════════════════════════════════════════════════════════════
    # CONVERT — .exfat → .ffpfsc (direct pack) / .ffpkg → .ffpfsc (extract)
    # ════════════════════════════════════════════════════════════════
    ...
    _card_head(card_c, '\U0001f504', 'Convert .exfat / .ffpkg  \u2192  .ffpfsc',
               'Packs the image straight into a compressed PFS container \u2014 no extraction')
    ...
    btn_c = make_themed_button(btn_row_c, text='Convert now',
    ...
    btn_cq_run = make_themed_button(btn_row_c, text='Convert all',
