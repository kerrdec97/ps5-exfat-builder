...
RELEASE = {
    "version": "3.6.3",
    "title": "Faster Workflows & Smarter Progress",
    "summary": ("A major update focused on faster workflows, smarter progress "
                "tracking, improved extraction performance, and a cleaner "
                "user experience."),
    "highlights": [
        "Faster existing-image conversions (instant hard-link staging)",
        "Smarter progress tracking (byte-based, accurate ETAs)",
        "Format-aware build phases (5 for exFAT/ffpkg, 6 for ffpfsc)",
        "Optional multithreaded Robocopy extraction (Windows)",
    ],
    "improvements": [
        "Build finalization visibility (flush / dismount / verify stages)",
        "Telemetry: filtered speed spikes, smoother ETA, clamped file counts",
        "Universal external mkpfs tool support with settings migration",
        "New single-modal release experience; no startup donation popup",
    ],
    "supporters": 6,
