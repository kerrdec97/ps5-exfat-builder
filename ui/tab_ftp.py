...
def _build_upload_subtab(parent, app):
    ...
    # Header
    tk.Label(body, text=_('Quick Upload to PS5'),
    ...
    type_row = tk.Frame(body, bg=COLORS['bg_1'])
    ...
    # Local path
    lbl_row = tk.Frame(body, bg=COLORS['bg_1'])
    lbl_row.pack(fill='x')
    ...
    local_inner = tk.Frame(body, bg=COLORS['bg_1'])
    ...
    # Remote path
    tk.Label(body, text=_('PS5 remote path'),
             font=FONTS['label'],
             bg=COLORS['bg_1'], fg=COLORS['fg_3'], anchor='w'
             ).pack(fill='x')
    remote_inner = tk.Frame(body, bg=COLORS['bg_1'])
    ...
    btn_row = tk.Frame(body, bg=COLORS['bg_1'])
    ...
    tk.Label(body, textvariable=app._ftptab_status_var,
             font=FONTS['body'],
             bg=COLORS['bg_1'], fg=COLORS['success_hi'],
             anchor='w'
             ).pack(fill='x', pady=(14, 4))

    bar_bg = tk.Frame(body, bg=COLORS['bg_4'], height=8)
    ...
    tk.Label(body, textvariable=app._ftptab_eta_var,
             font=FONTS['mono_sm'],
             bg=COLORS['bg_1'], fg=COLORS['fg_4'],
             anchor='w'
    ...
    # Output log
    tk.Label(body, text=_('OUTPUT LOG'),
             font=(FONTS['eyebrow'][0], 8, 'bold'),
             bg=COLORS['bg_1'], fg=COLORS['fg_5'], anchor='w'
             ).pack(fill='x', pady=(8, 4))
    log_frame = tk.Frame(body, bg=COLORS['bg_3'],
...
def _build_browser_subtab(parent, app):
    ...
    ws.grid_rowconfigure(1, weight=0)
    ws.grid_columnconfigure(0, weight=1)

    # ── Top — panes container ──
    panes_row = tk.Frame(ws, bg=COLORS['bg_1'])
    panes_row.grid(row=0, column=0, sticky='nsew',
                   padx=16, pady=(12, 8))
    ...
    _build_xfers_panel(ws, app).grid(row=1, column=0, sticky='ew',
                                      padx=16, pady=(0, 12))
