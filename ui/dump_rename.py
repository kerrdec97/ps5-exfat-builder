...
class DumpRenameTab:
    ...
    def _build_footer(self, parent):
        ...
        # Big rename button
        _accent_btn(foot, '\u270f  ' + _('Rename selected'),
    ...
    def _refresh_kpi(self):
        # Old inspector had KPI cards; the new tab shows a count next to
        # "Found dumps" instead. Hook the same refresh path.
        self._refresh_count()
