...
_FALLBACK_DONORS = {
    ...
    'donors': ['AceInTheHole', 'gas17', 'Helio Rogerio Silva Lopes', 'BigBoss83', 'Long Ho'],
    'has_anonymous': True,
}
...
def build_about_tab(parent, app):
    ...
    def _open_report():
        try:
            app._show_report_issue()
        except Exception:
            pass

    tk.Button(foot, text='\U0001f41b  ' + _('Report Issue'),
              font=(FONTS['button'][0], 9, 'bold'),
              bg=COLORS['bg_3'], fg=COLORS['fg_1'],
              activebackground=COLORS['bg_4'], activeforeground=COLORS['fg_0'],
              relief='flat', bd=0, padx=14, pady=6,
              cursor='hand2',
